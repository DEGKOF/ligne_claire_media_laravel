        ...
        <div class="container mx-auto px-4">
            ...
            <div class="text-center mb-12">
                ...
                <p class="text-lg text-gray-600 max-w-3xl mx-auto">
                    Vous souhaitez contacter la rédaction de Ligne Claire Média+
                    pour une information, une proposition éditoriale, une demande de partenariat,
                    une réaction à un article ou une demande d’interview ? <br>
                    Notre équipe est à votre écoute. <br>
                    Nous nous engageons à traiter chaque demande avec attention et professionnalisme.
                    Les messages à caractère éditorial, institutionnel ou journalistique seront examinés par la rédaction
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+22900000000" class="text-blue-600 hover:text-blue-800 hover:underline">
                                    +229 01 97 37 30 52
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="bg-gradient-to-br from-blue-600 to-blue-800 rounded-xl shadow-lg p-6 text-white">
                        ...
                        <div class="flex gap-3">
                            <a href="https://www.facebook.com/share/17WqUWiE6U/?mibextid=wwXIfr"
                            ...
                            <a href="https://youtube.com/@lcmafrica?si=4dww2i3cV3KDzhWF"
                                class="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                            ...
                            <a href="https://www.linkedin.com/company/ligne-claire-m%C3%A9dia/"
                                class="w-10 h-10 bg-white/20 hover:bg-white/30 rounded-full flex items-center justify-center transition">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                    <path
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-xl shadow-lg p-8">
                        ...
                        @if (session('contact_success'))
                            <div
                                class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg mb-6 flex items-start gap-3">

    ...
    <style>
        ...
        * {
        ...
        .card {
            ...
            border-radius: 12px;
            padding: 24px;
            box-shadow: 0 6px 24px var(--glass);
        }
        ...
        .badge {
            ...
            background: linear-gradient(135deg, #ddf7e6, #c7f0d8)
        }
                ...
                <div class="header">
                    <div class="badge" aria-hidden>
                        ...
                        <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                            <path
                                d="M9.00039 16.2L4.80039 12.0L3.40039 13.4L9.00039 19.0L21.0004 7.0L19.6004 5.6L9.00039 16.2Z" />
                        </svg>
                    </div>
                    <div>
                        <h1 id="title">Paiement confirmé — merci !</h1>
                        <p class="lead">Votre paiement a été traité avec succès. Ci‑dessous le récapitulatif de la
                            transaction.</p>
                    </div>
                </div>
                    ...
                    <div>
                        <div class="order-summary">
                            <div class="meta">
                                ...
                                <div><strong>Jean Dupont (fictif)</strong></div>
                            </div>
                            <div class="meta">
                                <div class="muted">Référence transaction</div>
                                <div><strong>#TXN-2025-09-0157</strong></div>
                            </div>
                            <div class="meta">
                                <div class="muted">Date</div>
                                <div><strong>29 octobre 2025 — 13:05</strong></div>
                            </div>
                            <div class="meta">
                                <div class="muted">Moyen de paiement</div>
                                <div><strong>Carte bancaire • Visa</strong></div>
                            </div>
                            ...
                            <div class="receipt">ID paiement: <strong>pay_64f9c2b1f3a2</strong> • Autorisation:
                                <strong>AUTH-88211</strong></div>
                        ...
                        <div style="margin-top:14px;color:var(--muted);font-size:13px">
                            <strong>Note :</strong> Ceci est un exemple avec des données fictives. Pour un usage réel,
                            chargez ici les vraies données retournées par votre passerelle de paiement (ID, montant, statut,
                            QR/URL du reçu...).
                        </div>
                    </div>

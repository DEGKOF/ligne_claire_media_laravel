...
// Si un montant est pré-rempli, afficher le formulaire et scroller
@if(isset($prefilledAmount))
    document.addEventListener('DOMContentLoaded', function() {
        // Afficher le formulaire de don
        const donForm = document.getElementById('payment-form-don');
        if (donForm) {
            donForm.classList.add('active');

            // Marquer le montant comme actif
            ...
            // Scroller vers le formulaire après un court délai
            setTimeout(() => {
                donForm.scrollIntoView({
                    behavior: 'smooth',
                    block: 'center'
                });
            }, 300);

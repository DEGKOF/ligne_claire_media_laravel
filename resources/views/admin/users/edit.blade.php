            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="role" id="role" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent @error('role') border-red-500 @enderror">
                        ...
                        <option value="advertiser" {{ old('role', $user->role) === 'advertiser' ? 'selected' : '' }}>Annonceur</option>
                    </select>
                    @error('role')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div class="border-t pt-4 mt-4">
                    <p class="text-sm text-gray-600 mb-4">Laisser vide pour ne pas modifier le mot de passe</p>

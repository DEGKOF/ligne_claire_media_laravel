        ...
        <div class="bg-white rounded-lg shadow p-6 grid grid-cols-2 gap-4">
            ...
            <div>
                ...
                <select name="type"
                    ...
                    <option value="rediffusion" {{ old('type') == 'rediffusion' ? 'selected' : '' }}>📺 Rediffusion</option>
                    <option value="video_courte" {{ old('type') == 'video_courte' ? 'selected' : '' }}>📹 Vidéo courte</option>
                    <option value="lien_externe" {{ old('type') == 'lien_externe' ? 'selected' : '' }}>🔗 Lien externe</option>
                </select>
                @error('type')
                    <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                @enderror
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <select name="status"
                        ...
                        <option value="hidden" {{ old('status') == 'hidden' ? 'selected' : '' }}>👁️‍🗨️ Masqué</option>
                    </select>
                    @error('status')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror

                            ...
                            <div class="space-y-4">
                                ...
                                {{-- <label class="flex items-center p-4 border-2 border-gray-300 rounded-lg cursor-pointer hover:border-blue-500 transition">
                                    <input type="radio"
                                           ...
                                           class="w-5 h-5 text-blue-600">
                                    <span class="ml-4 flex-1">
                                        <strong class="block text-lg">🏦 Virement bancaire</strong>
                                        <span class="text-sm text-gray-600">Transfert bancaire direct</span>
                                    </span>
                                </label> --}}
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-lg p-6 sticky top-4">
                        ...
                        <div class="border-t pt-4 mt-4">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="text-3xl font-black text-blue-600">{{ number_format($issue->digital_price, 2) }} FCFA</span>
                            </div>
                        </div>

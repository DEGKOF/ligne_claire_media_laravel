            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="grid grid-cols-3 gap-4">
                        ...
                        <label class="flex items-center p-4 border-2 border-gray-200 rounded-lg cursor-pointer hover:border-blue-500">
                            <input type="radio" name="content_type" value="html" class="mr-3">
                ...
                <div id="content-html" style="display:none;">
                    ...
                    <textarea name="html_content" rows="6"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 font-mono text-sm">{{ old('html_content') }}</textarea>
                </div>
...
document.querySelectorAll('input[name="content_type"]').forEach(radio => {
    radio.addEventListener('change', function() {
        ...
        document.getElementById('content-html').style.display = 'none';

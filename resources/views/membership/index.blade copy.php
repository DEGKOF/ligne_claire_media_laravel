    ...
    <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            <form action="{{ route('membership.store') }}" method="POST" id="membershipForm">
                ...
                <!-- Signature -->
                {{-- <div class="mt-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-4 border-b pb-2">Signature</h3>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Dessinez votre signature *</label>
                        <div class="border-2 border-gray-300 rounded-lg bg-white">
                            <canvas id="signatureCanvas" width="600" height="600" class="w-full cursor-crosshair"></canvas>
                        </div>
                        <input type="hidden" name="signature" id="signatureData">
                        <button type="button" onclick="clearSignature()" class="mt-2 text-sm text-blue-600 hover:text-blue-800">
...
<script>
    ...
    document.getElementById('membershipForm').addEventListener('submit', function(e) {
        if (!signatureData.value) {
            e.preventDefault();
            alert('Veuillez signer le formulaire avant de soumettre.');
            return false;
        }
